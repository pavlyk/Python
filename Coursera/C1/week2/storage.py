...
def parse_args():
    ...
    Используется если вызывать из консоли скрипт storage.py -h
    """
...
def get(key):
    ...
    # Получения значения по ключу, если нет то значение по умолчанию
    return data.get(key, [])
...
if __name__ == "__main__":
    ...
    if args.key and args.val:
        ...
        # Распаковка значений через разделитесь
